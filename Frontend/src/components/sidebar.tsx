...
export default function Sidebar() {
  let navbarItems = [
    ...
    icon: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14" strokeWidth="1" stroke="currentColor" className="w-6 h-6">
    ...
    icon: <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" strokeWidth="1.5" className="w-6 h-6">
