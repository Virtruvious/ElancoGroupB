...
export default function Sidebar() {
  let navbarItems = [
    ...
    icon: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14" stroke-width="1" stroke="currentColor" className="w-6 h-6">
            <path stroke-linecap="round" stroke-linejoin="round" d="M6.992 12.413L1.573 7.401c-2.953-2.966 1.355-8.71 5.419-4.064c4.064-4.632 8.412 1.111 5.418 4.064z M3.515 6.753h1.53l1.032-1.968L7.64 8.41l1.343-1.657h1.5" />
          </svg>},
    { name: "Temperature Tracker ", href: "/temperature",
    icon: <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="2 2 20 20" className="w-6 h-6">
    ...
    icon: <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" stroke-width="1.5" className="w-6 h-6">
  ...
  return (
    <aside className="group flex flex-col md:p-1 bg-elanco">
      <img
        src="/LogoWhite.png"
        alt="Elanco Logo"
      ...
      <nav className="flex flex-col gap-y-3 items-center mx-3">
        {navbarItems.map((item) => (
          ...
          >
            ...
            <span className="
                w-0 md:w-auto group-hover:w-[10rem] whitespace-nowrap
      ...
      <div className="mt-auto items-center justify-between m-3">
        ...
        <button
          onClick={() => signOut()}
          className="flex justify-center md:gap-3 group-hover:gap-3 p-3 
          ...
          <span className=" w-0 md:w-auto group-hover:w-[10rem] whitespace-nowrap
                scale-x-0 md:scale-x-100 group-hover:scale-x-100
