...
import LineGraph from "@/components/charts/Weight";
      ...
      <div className="bg-white w-full text-black h-screen overflow-auto">
        ...
        <div className="px-3 grid grid-cols-1 lg:grid-cols-3">
            <div className="col-span-full text-center
              ...
              <div className="font-bold lg:text-end text-elanco text-2xl md:text-3xl lg:text-5xl col-span-3 self-end">Weight (KG){/* name */}</div>
              <div className="p-5 w-full aspect-video rounded-md row-span-2 col-span-5 ml-2"><LineGraph/></div>
              <div className="text-base lg:text-end col-span-3">The past seven days of your dog's weight!</div>
            </div>
        </div>
